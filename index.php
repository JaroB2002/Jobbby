...
<head>
  ...
  <link rel="stylesheet" href="../Workz2/css/jobs.css">
  ...
  <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Wij bij Jobby vinden het makkelijk als jij je studentenjob zo snel mogelijk kan vinden om je cv uit te breiden!</p>
...
<div class="center-jobs">
        <div class="all-jobs">
                <?php foreach($jobs as $job): ?>
                        ...
                        ?>
                        <a href="../workz2/job.php?id=<?php echo $job['id'];?>">
                            <div class="vac-title">
                            ...
                            <div class="card-bottom">
                                <div class="side-side">
                                    <div>
                                        <img id="chrome" src="../Workz2/images/chrome.png" alt="">
                                    </div>
                                    <div class="vac-beschrijving">
                                        ...
                                        <div class="favorite">
                                            <img src="../Workz2/images/favorite.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
  ...
  <div class="grid gap-5 sm:grid-cols-2">
    <div class="flex w-full flex-col items-start justify-between rounded-lg bg-gray-100 p-8 shadow-md md:flex-row">
      <div class="rounded-xl bg-blue-100 p-3 sm:w-1/2">
        <img src="images/Verkoop_picture.jpg" alt="Verkoopsstudent" class="w-full rounded-2xl" />
      </div>
      <div class="sm:ml-4 mt-4 sm:mt-0">
        ...
        <ul class="mt-3 list-inside list-disc">
          <li class="list-none mb-1"><a href="#" class="text-blue-600 hover:underline">Tekst opsomming 1</a></li>
          <li class="list-none mb-1"><a href="#" class="list-none text-blue-600 hover:underline">Tekst opsomming 2</a></li>
          <li class="list-none mb-1"><a href="#" class="list-none text-blue-600 hover:underline">Tekst opsomming 3</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="flex w-full flex-col items-start justify-between rounded-lg bg-gray-100 p-8 shadow-md md:flex-row">
      <div class="rounded-xl bg-blue-100 p-3 sm:w-1/2">
        <img src="images/ContCreatie.jpg" alt="Content creator" class="w-full rounded-2xl" />
      </div>
      <div class="sm:ml-4 mt-4 sm:mt-0">
                ...
                <div>
                  ...
                  <div class="mt-4">
                    ...
                    <p class="mt-4 leading-relaxed text-gray-500">
                     Als werkgever ben ik enorm tevreden over Jobby. De kwaliteit van de kandidaten is hoog en de communicatie met Jobby is prettig. Ik kan Jobby aan iedereen aanbevelen.
                    </p>
                  </div>
                </div>
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    ...
                    <p class="mt-4 leading-relaxed text-gray-500">
                      Als werkgever is het vaak moeilijk om de juiste student te vinden voor een kleine microjob. Dankzij de elite formule van Jobby is dit verleden tijd. 
                    </p>
                  </div>
                </div>
...
<div class="bg-white py-12">
  <div class="mx-40 grid grid-cols-1 sm:grid-cols-2 gap-2">
    <div class="p-6 rounded-lg border bg-cover" style="background-image: url('images/RegisterStud.jpg'); background-color: rgba(255, 255, 255, 0.1);">
      ...
      <p class="mb-4">Altijd al gewild om je cv uit te breiden en je droomstudentenjob te vinden? Dromen bestaan niet, of toch wel?! Met Jobby komen je dromen uit!</p>
