     ...
     <div class="md:flex md:items-center md:justify-center w-full  md:h-full sm:rounded-lg md:rounded-none bg-white px-6">
       <div class="max-w-md w-full mx-auto">
         <div>
           ...
           <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Maak je account</h2>
              ...
              <div class="rechts">
                ...
                <div class="form-part-last">
                    ...
                    <label class="agree" for="terms-agree">
                        Ik heb de 
                        <a target="_blank" href="../Workz2/privacypolicy.php">terms and conditions</a>
                        gelezen.
                    </label>   
                </div>
