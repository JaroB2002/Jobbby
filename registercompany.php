<?php 
    ...
    if(isset($_POST['register'])){
        ...
        $user->setKbo($_POST['kbo']);
        $user->setWerkemail($_POST['email']);
        $user->setTelnr($_POST['telnr']);
        $user->setPassword($_POST['password']);
        $user->setBedrijfsnaam($_POST['bedrijfsnaam']);
        $user->insertBedrijf();
     ...
     <div class="md:flex md:items-center md:justify-center w-full  md:h-full sm:rounded-lg md:rounded-none bg-white px-6">
       <div class="max-w-md w-full mx-auto">
         <div>
           ...
           <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Maak je bedrijfsaccount</h2>
           <p class="mt-2 text-center text-sm text-gray-600"> Maak een <a href="register.php" class="font-medium text-indigo-600 hover:text-indigo-500"> studentenacount</a>.<br><br>
           <p class="mt-2 text-center text-sm text-gray-600"> Of <a href="login.php" class="font-medium text-indigo-600 hover:text-indigo-500">log in</a>.<br><br>           </p>
         </div>
         <form id="sign-up-form" action="" method="POST" aria-label="Sign up form">
          <div class="form-container">
            <div class="links">
                    ...
                    <div class="form-part">
                        <label  class="input-title" for="email" >Werk E-mail<br></label>
              ...
              <div class="rechts">
                  ...
                  <div class="form-part">
                      <label  class="input-title" for="bedrijfsnaam">Bedrijfsnaam<br></label>
                      <input type="text"  class="inputter" name="bedrijfsnaam" id="bedrijfsnaam" placeholder="">
                  </div>
                ...
                <div class="form-part">
                      <label  class="input-title" for="kbo">KBO-nummer<br></label>
                      <input type="text"  class="inputter" name="kbo" id="kbo" placeholder="">
                  </div>
