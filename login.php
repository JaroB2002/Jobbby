<?php 
  ...
  if(isset($_POST['email']) && isset($_POST['password']))
  {
    ...
    if(User::canLogin($_POST['email'], $_POST['password'])){
      ...
      if ($user['is_bedrijf'] === 1){
        $_SESSION['isBedrijf'] = true;
      } 
     ...
     <div class="md:flex md:items-center md:justify-center w-full  md:h-full sm:rounded-lg md:rounded-none bg-white px-6">
       <div class="max-w-md w-full mx-auto">
         <div>
           ...
           <p class="mt-2 text-center text-sm text-gray-600"> of maak je <a href="register.php" class="font-medium text-indigo-600 hover:text-indigo-500">account</a> aan.
           </p>
         </div>
