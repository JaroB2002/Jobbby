...
<head>
  ...
  <link rel="stylesheet" href="../Jobbby/css/cvmaker.css">    <title>CSS Maker</title>
</head>


<body>
<?php include_once("/xampp/htdocs/php/Jobbby/compartments/header.php")?>
<form id="cv-form" action="" method="POST" aria-label="Cv form">
    <div class="cv-personal">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/profile.png" alt="">
                <h2 id="pic-title">Persoonlijke gegevens</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivUno()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivUno()"></a>
            </div>
            <div id="cv-questions">
    ...
    <div class="cv-school">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/education.png" alt="">
                <h2 id="pic-title">Opleiding(en)</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivDos()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivDos()"></a>
            </div>
...
<div class="cv-work">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/work.png" alt="">
                <h2 id="pic-title">Werkervaring</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivTres()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivTres()"></a>
            </div>
    ...
    <div class="cv-computer">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/laptop.png" alt="">
                <h2 id="pic-title">Computervaardigheden</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivFour()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivFour()"></a>
            </div>
    ...
    <div class="cv-persoonlijk">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/persoonlijk.png" alt="">
                <h2 id="pic-title">Persoonlijke vaardigheden</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivFive()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivFive()"></a>
            </div>
    ...
    <div class="cv-beschikbaar">
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/vector.png" alt="">
                <h2 id="pic-title">Beschikbaarheden</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivSix()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivSix()"></a>
            </div>
        ...
        <div class="cv-title">
            <div class="cv-name">
                <img id="pic" src="../Jobbby/images/plus.png" alt="">
                <h2 id="pic-title">Extra's</h2>
            </div>
            <div class="arrows">
                <a href="#"><img id="min" src="../Jobbby/images/min.png" onclick="hideDivSeven()"></a>
                <a href="#"><img id="plus" src="../Jobbby/images/plus.png" onclick="showDivSeven()"></a>
            </div>
...
<?php include_once("/xampp/htdocs/php/Jobbby/compartments/footer.php")?>
