<footer class="bg-gray-900 text-white">
  <div class="container mx-auto px-10 py-6 flex flex-wrap justify-between md:flex-row">
    ...
    <div class="w-full md:w-2/12 mb-6 md:mb-0">
      ...
      <ul>
        <li class="mb-2"><a href="index.php">Over</a></li>
        <li class="mb-2"><a href="contact.php">Contact</a></li>
        <li class="mb-2"><a href="pricing.php">Prijzen</a></li>
      </ul>
    </div>
    ...
    <div class="w-full md:w-2/12 mb-6 md:mb-0">
      ...
      <ul>
        <li class="mb-2"><a href="jobs.php">Bekijk jobs</a></li>
        <li class="mb-2"><a href="#">Bekijk aanbieders</a></li>
        <li class="mb-2"><a href="public/cards.html">Opgeslagen jobs</a></li>
      </ul>
    </div>
    <div class="w-full md:w-2/12 mb-6 md:mb-0">
      <h2 class="text-xl font-bold mb-4">Werkaanbieders</h2>
      <ul> 
        <li class="mb-2"><a href="company/vacaturemaker.php">Plaats een vacature</a></li>
